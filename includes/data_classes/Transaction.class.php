<?php
	...
	class Transaction extends TransactionGen {
		...
		public function __toString() {
			return sprintf('Transaction Object %s',  $this->intId);
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Transaction objects
			return Transaction::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Transaction()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Transaction()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Transaction object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Transaction objects
			return Transaction::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Transaction()->Param1, $strParam1),
					QQ::Equal(QQN::Transaction()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
