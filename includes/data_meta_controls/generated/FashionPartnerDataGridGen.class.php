<?php
	 ...
	 * listing a collection of FashionPartner objects.  It includes
	 ...
	 * 
	 */
	class FashionPartnerDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FashionPartner datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FashionPartner object, or it can be any QQNode extending from QQN::FashionPartner().
		 * 
		 ...
		 * sorting using two fields from the FashionPartner object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FashionPartner
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FashionPartner::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from FashionPartner, given the clauses above
			$this->DataSource = FashionPartner::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a FashionPartner-based QQNode.
		 * It will also verify that it is a proper FashionPartner-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'fashion_partner') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "fashion_partner".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::FashionPartner()->Id;
				case 'Name': return QQN::FashionPartner()->Name;
				case 'Description': return QQN::FashionPartner()->Description;
				case 'Street': return QQN::FashionPartner()->Street;
				case 'City': return QQN::FashionPartner()->City;
				case 'State': return QQN::FashionPartner()->State;
				case 'Zipcode': return QQN::FashionPartner()->Zipcode;
				case 'Phone': return QQN::FashionPartner()->Phone;
				case 'Email': return QQN::FashionPartner()->Email;
				case 'ContactPerson': return QQN::FashionPartner()->ContactPerson;
				default: throw new QCallerException('Simple Property not found in FashionPartnerDataGrid content: ' . $mixContent);
