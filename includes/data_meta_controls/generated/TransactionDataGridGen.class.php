	...
	class TransactionDataGridGen extends QDataGrid {
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Transaction()->Id;
				case 'DonationId': return QQN::Transaction()->DonationId;
				case 'Donation': return QQN::Transaction()->Donation;
				case 'NeedId': return QQN::Transaction()->NeedId;
				case 'Need': return QQN::Transaction()->Need;
				case 'DateInitiated': return QQN::Transaction()->DateInitiated;
				case 'NumberOfUnits': return QQN::Transaction()->NumberOfUnits;
