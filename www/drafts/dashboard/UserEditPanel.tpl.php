...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->lstAccessLevelObject->RenderWithName(); ?>

		<?php $_CONTROL->lstCharityPartnersAsCharity->RenderWithName(true, "Rows=7"); ?>

		<?php $_CONTROL->lstFashionPartnersAsFashion->RenderWithName(true, "Rows=7"); ?>
