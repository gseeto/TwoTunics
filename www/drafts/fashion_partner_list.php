<?php
	 ...
	 * FashionPartnerDataGrid control which has meta-methods to help with
	 * easily creating/defining FashionPartner columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both fashion_partner_list.php AND
	 * fashion_partner_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class FashionPartnerListForm extends QForm {
		// Local instance of the Meta DataGrid to list FashionPartners
		protected $dtgFashionPartners;
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgFashionPartners->ItemsPerPage = 20;

			// Use the MetaDataGrid functionality to add Columns for this datagrid

			// Create an Edit Column
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/fashion_partner_edit.php';
			$this->dtgFashionPartners->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
	...
	// fashion_partner_list.tpl.php as the included HTML template file
	FashionPartnerListForm::Run('FashionPartnerListForm');
?>