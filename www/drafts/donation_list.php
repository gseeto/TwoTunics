<?php
	 ...
	 * DonationDataGrid control which has meta-methods to help with
	 * easily creating/defining Donation columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both donation_list.php AND
	 * donation_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class DonationListForm extends QForm {
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgDonations->ItemsPerPage = 20;

			// Use the MetaDataGrid functionality to add Columns for this datagrid

			// Create an Edit Column
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/donation_edit.php';
			$this->dtgDonations->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
	...
	// donation_list.tpl.php as the included HTML template file
	DonationListForm::Run('DonationListForm');
?>