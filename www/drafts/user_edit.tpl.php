...
?>
	...
	<div id="formControls">
		...
		<?php $this->lstAccessLevelObject->RenderWithName(); ?>

		<?php $this->lstCharityPartnersAsCharity->RenderWithName(true, "Rows=7"); ?>

		<?php $this->lstFashionPartnersAsFashion->RenderWithName(true, "Rows=7"); ?>
